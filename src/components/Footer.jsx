      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          <div className="footer-brand">
            <span className="footer-logo-badge">S2T</span>
            <span className="footer-brand-name">Student2Techie Academy</span>
          </div>
          <p className="footer-tagline">
            From Campus to Career — Your Internship Starts Here
          </p>
        </div>
        ...
        <div className="footer-columns">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#programs">Full Stack MERN</a></li>
              <li><a href="#programs">Python &amp; Data Science</a></li>
              <li><a href="#programs">UI/UX Design</a></li>
              <li><a href="#programs">Mobile Apps</a></li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; 2025 Student2Techie Academy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
